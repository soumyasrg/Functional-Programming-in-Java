...
public class FP04CustomClass {
	...
	public static void main(String[] args) {
		...
		// compare by no. of students then by no. of reviews
		System.out.println(
				courses.stream()
		...
		// after skipping top 3, print top 5 results
		System.out.println(
				courses.stream()
				.sorted(comparingByNoOfStudentsAndNoOfReviews)
				.skip(3)
		...
		//take the elements while a certain condition is met i.e. review score >= 95
		// if one element breaks the criteria, skip all elements after that
		System.out.println(
			courses.stream()
		...
		// as long as condition is true drop them,
		// if one elements found meeting that criteria, then take
		...
		// max -> sorts the list using the comparision criteria 
		// and returns the last element in this sorted list
		System.out.println(
				courses.stream()
		...
		// returns min orElse if it retruns null
		// then returns the default result given
		System.out.println(
				courses.stream()
		...
		// returns null so it returns default value
		System.out.println(
			courses.stream()
		...
		//finds first element meeting this criteria
		System.out.println(
				courses.stream()
				.filter(reviewScoreLessThan90Predicate)
				.findFirst()
		...
		// return any of elements from the stream
		...
		// get the max element meeting this criteria
		System.out.println(
				courses.stream()
				.filter(reviewScoreGreaterThan95Predicate)
				.mapToInt(Course::getNoOfStudents)
		...
		//  count occurences by some category
		System.out.println(
				courses.stream()
		...
		// get the course with max. reviewScore in each category
		System.out.println(
				courses.stream()
				.collect(Collectors.groupingBy(Course::getCategory, 
		...
		// map just name of courses instead of entire course, collect them in a list
		System.out.println(
				courses.stream()
				.collect(Collectors.groupingBy(Course::getCategory, 
	...
	// Higher order functions: a function which returns a function
	// here it returns a predicate (which can be a function)
	// example of HOF
